...
if __name__ == "__main__":
    # oxford dataset
    settings = load_settings("/home/yuanyong/python/icmr_pipeline/oxford/settings.json")
    ...
    pathDB = '/media/disk1/yuanyong/icmr_pipeline/icmr_results/oxford/features/vgg16/336_256/conv5_db'
